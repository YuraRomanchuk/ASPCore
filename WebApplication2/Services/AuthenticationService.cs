...
using IAuthenticationService = WebApplication2.Services.Interfaces.IAuthenticationService;
...
namespace WebApplication2.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IUserService userService, PasswordHasher passwordHasher, ITokenHandler tokenHandler)
        {
